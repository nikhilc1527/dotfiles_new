...
#+BEGIN_SRC emacs-lisp
  ...
  ;;   ;; Tell lsp-mode how to start coq-lsp
  ;;   (lsp-register-client
  ;;    (make-lsp-client
  ;;     :new-connection (lsp-stdio-connection
  ;;                      '("coq-lsp"))
  ;;     :activation-fn (lsp-activate-on "rocq")
  ;;     :server-id 'coq-lsp))
  ;;   )

  ;; ;; Proof General (includes Coq mode)
  (use-package proof-general
    ...
    :config
    ;; General Proof General settings
  ...
  ;;    (define-key coq-mode-map (kbd "C-c C-k")
  ;;                (lambda () (interactive) (proof-assert-until-point-interactive))))
