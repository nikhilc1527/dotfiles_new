...
(custom-set-variables
 ...
 '(company-coq-completion-predicate 'company-coq-in-code-p)
 '(company-coq-disabled-features '(smart-subscripts spinner))
 '(company-coq-live-on-the-edge nil)
 ...
 '(package-selected-packages
   '(ace-jump-mode all-the-icons-dired beacon cargo ccls company-coq
                   ...
                   find-temp-file fira-code-mode fixmee flash
                   ...
                   lsp-ui magit marginalia math-symbols move-text
                   nerd-icons-completion nyan-mode orderless
                   org-journal org-roam phi-search-mc projectile
                   proof-general rocq-mode rust-mode sudo-edit
                   toml-mode treesit-auto try typescript-mode
                   ultra-scroll undo-tree vertico virtualenvwrapper
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(flash-match ((t (:foreground "cyan" :underline t))))
