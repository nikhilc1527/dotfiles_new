...
(custom-set-variables
 ...
 '(lsp-haskell-server-path "/home/haddr/.ghcup/bin/haskell-language-server-wrapper")
 ...
 '(lsp-pylsp-server-command '("$HOME/.local/bin/pylsp"))
